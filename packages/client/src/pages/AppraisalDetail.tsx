                ...
                <div>
                  ...
                  <dl className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <dd className="font-medium text-gray-900">{appraisal.report_type || '—'}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-500">Valuation Method:</dt>
                      <dd className="font-medium text-gray-900">{appraisal.valuation_method || '—'}</dd>
                    </div>
                    <div className="flex justify-between">
                ...
                <div>
                  ...
                  <dl className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <dd className="font-medium text-gray-900">{appraisal.client_name || '—'}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-500">Client Email:</dt>
                      <dd className="font-medium text-gray-900">{appraisal.client_email || '—'}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-500">Client Phone:</dt>
                      <dd className="font-medium text-gray-900">{appraisal.client_phone || '—'}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-500">Lender:</dt>
                      <dd className="font-medium text-gray-900">{appraisal.lender_name || '—'}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-500">Loan Number:</dt>
                      <dd className="font-medium text-gray-900">{appraisal.loan_number || '—'}</dd>
                    </div>
                    <div className="flex justify-between">
                      <dt className="text-gray-500">Intended Use:</dt>
                      <dd className="font-medium text-gray-900">{appraisal.intended_use || '—'}</dd>
                    </div>
                  </dl>
                </div>
              </div>
