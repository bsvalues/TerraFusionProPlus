...
export default function Sidebar() {
  ...
  const navigationItems = [
    ...
    { title: "Market Analysis", path: "/market-analysis", icon: <BarChart2 className="mr-4 h-5 w-5 text-gray-400" /> },
    { title: "Analytics", path: "/analytics", icon: <TrendingUp className="mr-4 h-5 w-5 text-gray-400" /> },
